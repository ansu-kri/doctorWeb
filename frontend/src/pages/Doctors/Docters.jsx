      ...
      <section className="-mt-20 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          ...
          <div className="bg-orange-100 p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            {/* Hospital + Arrow Button */}
            <div className="flex justify-between items-center w-full mt-4">
              <p className="text-gray-600 text-[13px]">
                At Mount Adora Hospital, Sylhet
              </p>

              <button className="flex items-center bg-blue-500 text-white py-2 px-3 rounded-full">
                <svg
                  className="w-4 h-4"
          ...
          {/* Doctor Card 2 (same structure as card 1, only text changes) */}
          <div className="bg-purple-100 p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <div className="flex justify-between items-center w-full mt-4">
              ...
              <button className="flex items-center bg-blue-500 text-white py-2 px-3 rounded-full">
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
